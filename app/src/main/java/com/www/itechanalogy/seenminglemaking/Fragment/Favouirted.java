...
public class Favouirted extends Fragment {
    private View view;
    private RelativeLayout no_fav_section,edit_filter;
    private Button start_discovering;
    private ExpandableHeightGridView fav;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.inner_fav,container,false);
        checkNetwork();
        no_fav_section = view.findViewById(R.id.no_fav_section);
    ...
    private void getFav(final String id){
        blockedLists.clear();
