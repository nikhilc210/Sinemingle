...
public class Passed extends Fragment {
    private View view;
    private RelativeLayout no_passed_section,edit_filter;
    private Button start_discovering;
    private ExpandableHeightGridView passed;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.inner_passed,container,false);
        checkNetwork();
        no_passed_section = view.findViewById(R.id.no_passed_section);
    ...
    private void getPassed(final String id){
        blockedLists.clear();
                ...
                try {
                    ...
                    for(int i=0; i<array.length(); i++){
                        ...
                        if(blockedLists.size()>0){
                            no_passed_section.setVisibility(View.GONE);
                        }
                    }
                    final BlockedAdapter blockedAdapter = new BlockedAdapter(blockedLists,getActivity());
                    passed.setExpanded(true);
                    passed.setAdapter(blockedAdapter);
