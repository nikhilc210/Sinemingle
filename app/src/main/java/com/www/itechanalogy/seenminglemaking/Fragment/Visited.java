...
public class Visited extends Fragment {
    private View view;
    private RelativeLayout no_visited_section,edit_filter;
    private Button start_discovering;
    private ExpandableHeightGridView visited;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.inner_visited_you,container,false);
        checkNetwork();
        no_visited_section = view.findViewById(R.id.no_visited_section);
    ...
    private void getVisited(final String id){
        blockedLists.clear();
                ...
                try {
                    ...
                    for(int i=0; i<array.length(); i++){
                        ...
                        if(blockedLists.size()>0){
                            no_visited_section.setVisibility(View.GONE);
                        }
                    }
                    final BlockedAdapter blockedAdapter = new BlockedAdapter(blockedLists,getActivity());
                    visited.setExpanded(true);
                    visited.setAdapter(blockedAdapter);
