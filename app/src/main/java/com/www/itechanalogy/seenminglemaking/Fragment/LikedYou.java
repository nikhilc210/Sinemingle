...
public class LikedYou extends Fragment {
    private View view;
    private RelativeLayout no_liked_section,edit_filter;
    private Button start_discovering;
    private ExpandableHeightGridView liked_you;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.inner_liked_you,container,false);
        checkNetwork();
        no_liked_section = view.findViewById(R.id.no_liked_section);
        edit_filter = view.findViewById(R.id.edit_filter);
        liked_you = view.findViewById(R.id.liked_you);
    ...
    private void getLikedYou(final String id){
        blockedLists.clear();
                ...
                try {
                    ...
                    for(int i=0; i<array.length(); i++){
                        ...
                        if(blockedLists.size()>0){
                            no_liked_section.setVisibility(View.GONE);
                        }
                    }
                    final BlockedAdapter blockedAdapter = new BlockedAdapter(blockedLists,getActivity());
                    liked_you.setExpanded(true);
                    liked_you.setAdapter(blockedAdapter);
