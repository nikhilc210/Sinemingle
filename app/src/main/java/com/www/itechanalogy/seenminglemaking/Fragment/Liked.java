...
public class Liked extends Fragment {
    ...
    private ExpandableHeightGridView liked;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.liked,container,false);
        checkNetwork();
    ...
    private void getLiked(final String id){
        blockedLists.clear();
        ...
        StringRequest request = new StringRequest(Request.Method.POST, URLS.MY_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    liked.setExpanded(true);
                    liked.setAdapter(blockedAdapter);
